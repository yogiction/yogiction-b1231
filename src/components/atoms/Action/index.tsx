...
export default function Action(props) {
    ...
    return (
        <Link
            ...
            aria-label={altText}
            id={elementId}
            className={classNames('border-t-[0px] min-h-[95px] min-w-[456px] border-b-[0px] border-l-0 border-r-0  sb-component', 'sb-component-block ', style === 'link' ? 'sb-component-link' : 'sb-component-button', className, {
