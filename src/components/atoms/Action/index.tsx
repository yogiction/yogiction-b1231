...
export default function Action(props) {
    ...
    return (
        <Link
            ...
            aria-label={altText}
            id={elementId}
            className={classNames('border-t-[4px] border-b-[4px] border-l-0 border-r-0 border-gray-400 sb-component', 'sb-component-block ', style === 'link' ? 'sb-component-link' : 'sb-component-button', className, {
