            ...
            >
                ...
                >
                    ...
                    <div className={classNames('max-w-[899px] mx-auto xl:mt-0 md:mt-16')}>
                        ...
                        >
                            <img className=' mx-auto ml-[0px] max-w-[90%]  md:ml-0 mt-[60px] object-cover w-full	 max-h-[935px]' src="/images/aboutus2.png" alt="" />
                            <img className=' max-w-[218px] object-cover w-full max-h-[698px] mt-[-199px] ml-auto md:ml-[204px]' src="/images/aboutus1.png" alt="" />
                            <div className={classNames(
