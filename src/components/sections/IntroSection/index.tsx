...
export default function IntroSection(props) {
    ...
    const sectionImage = props.sectionImage.image || '';
    ...
    return (
        <>
            ...
            >
                ...
                <div className={classNames('flex xl:flex-row pl-0 md:pl-[80px] 2xl:pl-[140px] flex-col justify-center')}>
                    <div className={classNames('max-w-[899px] w-full order-last xl:order-1')}>
                        <div
                            className={classNames(
                    ...
                    <div
                        className={classNames('w-full', 'order-1 xl:order-last', 'mt-0 md:mt-[375px]')}
                        style={{
                            overflowX: 'hidden'
                        }}
                    >
                        <img
                            src={sectionImage}
                            className={classNames('h-auto md:max-h-[798px] md:max-w-[800px]  w-full', 'max-h-[227px] max-w-[238px] mx-auto')}
                            alt=""
                        />
                    </div>
                </div>
                <div className="flex">
                    <div
                        className={classNames('bg-gray-600 h-[1px] md:block hidden w-[100%]', 'mx-[13.7%] 2xl:mt-[200px] 2xl:mb-[200px]', 'my-[150px]')}
                        style={{
                            opacity: '0.35',
                            fill: 'transparent',
            ...
            {mobileCTA(props)}
            <div
                className={classNames('leading-[38px] pt-[60px]', 'text-[25px] font-semibold block md:hidden bg-[#e1e6ea] ')}
                style={{
                    textAlign: 'center',
                    fontFamily: 'Poppins',
                    fontStyle: 'normal',
            ...
            <div className={classNames('bg-[#e1e6ea] flex pb-[60px] md:hidden flex-col lg:flex-row justify-center')}>
                {props.benefits.map((item, index) => {
                    return (
                        <div key={index} className={classNames('flex flex-col  mt-[35px]')}>
                            <CheckedCircle className={classNames('mx-auto', 'h-[35px] w-[35px]')} />
                            <div
                                className={classNames('text-center mt-[15px] mx-auto font-sans', 'text-[18px] leading-[27px] font-normal')}
                                style={{
                                    color: 'rgba(23,52,80,1)'
                                }}
                            >
                ...
                >
                    {actions.map((action, index) => (
                        <Action
                            key={index}
                            {...action}
                            className="mb-0 mx-2  max-w-[456px] w-full max-h-[95px]  border-t-0 border-b-0 lg:whitespace-nowrap"
...
function mobileCTA(props) {
    ...
    return (
        <div
            className={classNames(
                'active:bg-[#2f6899]  hover:bg-[#2f6899] hover:cursor-pointer md:hidden w-full bg-[#2c5d87] h-[60px] items-center flex justify-center'
            )}
        >
