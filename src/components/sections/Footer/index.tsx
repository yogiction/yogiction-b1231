                ...
                {(primaryLinks.length > 0 || socialLinks.length > 0 || props.contacts) && (
                    <div className="sm:flex flex-col  lg:flex-row sm:justify-between sm:items-start">
                        <div className="max-w-[680px] mx-[41px] mb-[53px] md:mb-0 md:mx-0">
                            <div
                                className="mb-[40px] md:mb-[60px] leading-[38px] md:leading-[60px] text-[25px] md:text-[40px] md:text-left text-center font-semibold"
                            ...
                            <div className="flex h-full flex-col justify-between">
                                <div
                                    className="leading-[27px] md:mb-[48px] mb-8 md:leading-[46px]  md:text-[30px] text-[18px]"
                                    style={{
                                        textAlign: 'left',
                                        fontFamily: 'Poppins',
                                        fontStyle: 'normal',
                                ...
                                <div>{props.contacts && <Contacts {...props.contacts} />}</div>
                            </div>
                        </div>
                        <div className="md:mb-0 mb-[0px] md:w-full mt-[120px] md:mt-0 md:max-w-[680px] mx-[41px]">
                            <div
                                className="md:mb-[60px] mb-[40px] leading-[38px] md:leading-[60px]  md:text-left text-center text-[25px] md:text-[40px]   font-semibold"
                                style={{ fontFamily: 'Poppins' }}
                            >
                                {rightSectionTitle}
                            </div>
                            {socialLinks.length > 0 && (
                                <ul
                                    className="flex justify-evenly md:space-x-[34.18px] md:px-0 px-[27.79px] md:justify-start items-center mb-[40.5px] md:mb-[83px]"
                                    data-sb-field-path=".socialLinks"
                                >
                                    {socialLinks.map((link, index) => (
                                        <li
                                            className="md:w-[50px] w-[38.5px] md:h-[50px] text-white hover:text-[#a6bf36] h-[38.5px]"
                                            key={index}
                                            style={{
                            ...
                            <div
                                className="text-[18px] leading-[27px] md:text-[30px] md:leading-[46px]"
                                style={{
                                    textAlign: 'left',
                                    fontFamily: 'Poppins',
                                    fontStyle: 'normal',
...
function Contacts(props) {
    return (
        <div
            className="text-lg leading-[27px] md:leading-[46px] text-[18px] md:text-[30px]"
            data-sb-field-path=".contacts"
            style={{
                textAlign: 'left',
                fontFamily: 'Poppins',
                fontStyle: 'normal',
